...
=============================
Demonstrates the AutoML pipeline on a classification task using the Iris dataset.
"""
...
# ─── Run AutoML ──────────────────────────────────────────────────────────────
print("\n" + "=" * 60)
print("Starting AutoML Classification Pipeline")
print("=" * 60)
...
files = automl.export_model(output_dir="./models", model_name="iris_classifier")
